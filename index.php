<!DOCTYPE html lang="en" xmlns:fb="http://www.facebook.com/2008/fbml">
<html>
    <head>
        <meta charset="UTF-8">
      ...
      <div class="container">
        ...
        <ul id="tab">
            ...
            <li>
                ...
                <div id="hääletus"></div>
                <div id="logbtn">
                    <fb:login-button data-max-rows="1" data-size="xlarge" onlogin="checkLoginState();" data-show-faces="false" data-auto-logout-link="true"></fb:login-button>
                </div>
                <div class="datagrid">
                    <table>
                        <thead>
